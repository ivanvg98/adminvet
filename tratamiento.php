...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="consultas.php" class="active-inner">Consultas</a></li>
	...
	<div class="container-fluid">
		<h4><a href="consultas.php" class="btn btn-warning"> << REGRESAR </a> Información general de la consulta </h4> 
		<table class="table table-bordered">
			<thead>
				<tr>
					<th style="background: #9B9B9B;">Clave de la cosulta</th>
					<th style="background: #9B9B9B;">Fecha registro</th>
					<th style="background: #9B9B9B;">Cliente</th>
					<th style="background: #9B9B9B;">Cuenta Total</th>
					<th style="background: #9B9B9B;">Cuenta Pagada</th>
				</tr>
			</thead>
		...
		<div class="container-fluid row form-inline">
			<div class="container col-lg-6 text-left">
				<b class="title-table">Tabla de tratamientos</b> <button type='button' class='btn btn-success' data-toggle='modal' data-target='#modal_insert' id='btn-new'> Agregar nuevo tratamiento</button>
			</div>
			<div class="container col-lg-6 text-right">
				<label for="search"> Buscar tratamiento: </label>
